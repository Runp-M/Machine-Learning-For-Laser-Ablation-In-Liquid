...
def extract_rows(data):
    ...
    # Check if there are common names in 'ID experiment' column between df_80_percent and df_20_percent
    common_names = set(df_80_percent['ID experiment']) & set(df_20_percent['ID experiment'])
